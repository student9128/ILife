...
public class KotlinStudyFragment extends BaseFragment {
    public static KotlinStudyFragment newInstance(String s) {
        KotlinStudyFragment fragment = new KotlinStudyFragment();
