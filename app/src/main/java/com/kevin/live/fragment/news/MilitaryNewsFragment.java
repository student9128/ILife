...
public class MilitaryNewsFragment extends BaseFragment {
    public static MilitaryNewsFragment newInstance(String s) {
        MilitaryNewsFragment fragment = new MilitaryNewsFragment();
